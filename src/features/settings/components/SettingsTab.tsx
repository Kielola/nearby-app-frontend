...
interface SettingsTabProps {
  ...
  setSettingsSubView: (val: string) => void;
  showInstagramProfile: boolean;
  setShowInstagramProfile: (val: boolean) => void;
  ...
  userUsername: string;
  setUserUsername: (val: string) => void;
  userStatusText: string;
  setUserStatusText: (val: string) => void;
  userBio: string;
  setUserBio: (val: string) => void;
  userWebsite: string;
  setUserWebsite: (val: string) => void;
  userAgeRange: string;
  setUserAgeRange: (val: string) => void;
  userGender: string;
  setUserGender: (val: string) => void;
  userInterests: string[];
  setUserInterests: (val: string[]) => void;
  userPosts: any[];
  userHighlights: any[];
  friendIds: string[];
  ...
  handleAddNewFriend: (uid: string) => void;
  meetups: Meetup[];
  meetupRatings: MeetupRating[];
  handleRateNeighbor: (id: string, stars: number, comment: string) => void;
  handleReportNeighbor: (id: string, reason: string) => void;
  handleCancelMeetup: (id: string) => void;
  setScheduleMeetupTargetNeighbor: (n: Neighbor | null) => void;
  setScheduleMeetupPoint: (val: string) => void;
  setScheduleMeetupTime: (val: string) => void;
  ...
  setUploadMode: (val: 'photo' | 'highlight') => void;
  setViewingUserPostDetail: (val: any) => void;
  setShowFriendsModal: (val: boolean) => void;
  logoutUser: () => void;
  privacyLocationVisibility: boolean;
  setPrivacyLocationVisibility: (val: boolean) => void;
  isUserVisibleOnRadar: boolean;
  setIsUserVisibleOnRadar: (val: boolean) => void;
  gbHideOnline: boolean;
  setGbHideOnline: (val: boolean) => void;
  privacyReadReceipts: boolean;
  setPrivacyReadReceipts: (val: boolean) => void;
  gbFreezeLastSeen: boolean;
  setGbFreezeLastSeen: (val: boolean) => void;
  privacyTrustedOnly: boolean;
  setPrivacyTrustedOnly: (val: boolean) => void;
  notifMessages: boolean;
  setNotifMessages: (val: boolean) => void;
  notifFriendRequests: boolean;
  setNotifFriendRequests: (val: boolean) => void;
  notifMeetups: boolean;
  setNotifMeetups: (val: boolean) => void;
  notifRatings: boolean;
  setNotifRatings: (val: boolean) => void;
  notifNearbyUsers: boolean;
  setNotifNearbyUsers: (val: boolean) => void;
  notifEvents: boolean;
  setNotifEvents: (val: boolean) => void;
  appearanceMode: 'light' | 'dark' | 'system';
  setAppearanceMode: (val: 'light' | 'dark' | 'system') => void;
  gbAntiDelete: boolean;
  setGbAntiDelete: (val: boolean) => void;
  gbBlueTickOnReply: boolean;
  setGbBlueTickOnReply: (val: boolean) => void;
  privacyDisappearing: string;
  setPrivacyDisappearing: (val: string) => void;
  customChatBg: string;
  setCustomChatBg: (val: string) => void;
  customAccentColor: 'indigo' | 'emerald' | 'blue' | 'rose' | 'amber' | 'purple';
  setCustomAccentColor: (val: 'indigo' | 'emerald' | 'blue' | 'rose' | 'amber' | 'purple') => void;
  setAboutDetailModal: (val: string) => void;
  setConfirmDeleteAccount: (val: boolean) => void;
}
  ...
  const CustomSwitch = ({ checked, onChange }: { checked: boolean; onChange: () => void }) => {
    return (
      <button
        ...
        className={`w-11 h-6 rounded-full p-0.5 transition-colors duration-250 shrink-0 cursor-pointer relative flex items-center border-none outline-none ${
  ...
  return (
    <div className="h-full">
      {!showInstagramProfile ? (
              ...
              <div className="flex justify-between items-center text-left">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className={`p-2.5 rounded-full transition active:scale-95 relative cursor-pointer border-none outline-none ${
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-full transition active:scale-95 cursor-pointer border-none outline-none ${
                      appTheme === 'dark' ? 'bg-neutral-850 text-neutral-300 hover:bg-neutral-800' : 'bg-neutral-100 text-neutral-600 hover:bg-neutral-200'
                    }`}
                    title="Search Help"
                  >
              ...
              >
                ...
                <div className="flex items-center space-x-2 shrink-0">
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-xl text-[11px] font-bold transition active:scale-95 border-none outline-none cursor-pointer ${
                ...
                <div className={`p-4 border rounded-[24px] space-y-4 shadow-sm bg-gradient-to-br ${
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    <button
                      ...
                      className={`py-3 text-xs font-bold rounded-xl border flex items-center justify-center space-x-1.5 cursor-pointer transition active:scale-95 border-none outline-none ${
                        appTheme === 'dark' 
                          ? 'bg-neutral-900 border-neutral-800 text-neutral-300 hover:bg-neutral-800 hover:text-white' 
                          : 'bg-white border-stone-200 text-stone-700 hover:bg-stone-50 hover:text-neutral-900'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className="py-3 text-xs font-bold text-white bg-red-600 hover:bg-red-500 rounded-xl flex items-center justify-center space-x-1.5 cursor-pointer transition active:scale-95 shadow-sm border-none outline-none"
                    >
          ...
          {settingsSubView === 'privacy' && (
            ...
            >
              <button 
                ...
                className="flex items-center space-x-1.5 text-neutral-400 hover:text-white text-xs font-bold py-1 select-none border-none bg-transparent cursor-pointer"
              >
                ...
                <div className={`px-4 py-3 flex flex-col justify-center border-b ${
                  ...
                  <select 
                    ...
                    className={`w-full bg-transparent border rounded-xl px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-emerald-500 font-medium ${
                      appTheme === 'dark' ? 'bg-neutral-950 border-neutral-800 text-white' : 'bg-stone-50 border-stone-200 text-neutral-850'
                    }`}
                  >
                ...
                >
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-neutral-400 block">Nearby digital credentials agreement agreement agreement</span>
                    </div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-neutral-400" />
                </div>
        ...
        /* PREMIUM APPLE/AIRBNB STYLE PROFILE VIEW */
        <div className="transition-all duration-300 min-h-full flex flex-col bg-white overflow-y-auto">
          <React.Suspense fallback={<div className="p-8 text-center text-zinc-400 font-sans text-xs">Loading Profile...</div>}>
            <PremiumProfileView 
              isOwnProfile={true}
